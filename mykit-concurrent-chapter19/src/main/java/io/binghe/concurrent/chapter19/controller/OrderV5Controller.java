...
public class OrderV5Controller {
    ...
    private final Logger logger = LoggerFactory.getLogger(OrderV5Controller.class);
    ...
    public String submitOrder(){
        ...
        Boolean isLocked = stringRedisTemplate.opsForValue().setIfAbsent(PRODUCT_ID, String.valueOf(threadId), 30, TimeUnit.SECONDS);
        //获取锁失败，则直接返回下单失败
        if (!isLocked){
            return "failure";
        }
